    ...
    return (
      <SortableTree
        ...
        generateNodeProps={({ node, path }) => ({
          buttons: [
            node.subtitle !== "Simple Screen" && node.subtitle !== "" && <button onClick={() => addChild('Untitled' + id, 'Simple Screen', getNodeKey, path, id)} style={{ 'fontFamily': 'Arial', 'backgroundColor': '#37474f', 'outline': 'none', 'border': 'none' }}>
